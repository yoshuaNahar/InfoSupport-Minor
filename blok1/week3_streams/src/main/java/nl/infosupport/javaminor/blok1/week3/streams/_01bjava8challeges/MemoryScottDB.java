package nl.infosupport.javaminor.blok1.week3.streams._01bjava8challeges;
...
public class MemoryScottDB {
  ...
  public void initializeDB() {
    ...
    initializeEmployees();
    initializeBiDirectionalRelation(employees, departments);
    initializeSalaryGrades();
  }
  ...
  private void initializeSalaryGrades() {
  ...
  private void initializeBiDirectionalRelation(List<Employee> employees,
