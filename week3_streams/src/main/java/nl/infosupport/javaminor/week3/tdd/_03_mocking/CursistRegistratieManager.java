...
public class CursistRegistratieManager {
  ...
  private Map<String, Cursist> activaties = new ConcurrentHashMap<>();

  public CursistRegistratieManager(CursistDao cursistDao) {
    this.dao = cursistDao;
  }
   ...
   *
   * @param gebruikersnaam gebruikersnaam van de nieuwe cursist
   * @param email emailadres van de cursist
   * @return de activatiecode voor deze nieuwe registratie
   * @throws OngeldigeCursistRegistratie wanneer de gebruikersnaam al in gebruik is
   */
   ...
   *
   * @param gebruikersnaam De gebruikersnaam van de cursist
   * @param activatiecode De bijbehorende activatiecode die verkregen is bij registreren
   * @throws OngeldigeCursistActivatieException Wanneer de gegeven gebruikersnaam onbekend is of de
   * activatiecode ongeldig is of wanneer de cursist reeds geactiveerd is.
   */
