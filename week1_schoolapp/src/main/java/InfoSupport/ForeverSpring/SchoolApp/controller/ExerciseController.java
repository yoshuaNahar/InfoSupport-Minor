...
public class ExerciseController {
    ...
    @Autowired
    public ExerciseController(ExerciseRepository exerciseRepository, UserRepository userRepository, UserExerciseRepository userExerciseRepository) {
    ...
    String contributors(Model model, @PathVariable int exerciseId) {
        ...
        model.addAttribute("contributors", this.userExerciseRepository.findByExerciseId(exercise.getId()));
